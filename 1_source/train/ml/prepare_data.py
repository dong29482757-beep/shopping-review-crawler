...
SRC = os.path.join(ROOT, "1_source", "merged_reviews_all.csv")
OUT_TRAIN = os.path.join(ROOT, "1_source", "train", "ml", "train.csv")
OUT_TEST = os.path.join(ROOT, "1_source", "train", "ml", "test.csv")
