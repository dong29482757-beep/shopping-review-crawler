...
TRAIN = os.path.join(ROOT, "1_source", "train", "ml", "train_tok.csv")
TEST = os.path.join(ROOT, "1_source", "train", "ml", "test_tok.csv")
OUT_DIR = os.path.join(ROOT, "2_executable", "models")
